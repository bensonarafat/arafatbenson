import { version, defineComponent, h, inject, computed, unref, Suspense, nextTick, Transition, provide, reactive, getCurrentInstance, ref, resolveComponent, shallowRef, useSSRContext, createApp, toRef, isRef, defineAsyncComponent, onErrorCaptured, withCtx, createVNode } from 'vue';
...
const appHead = { "meta": [{ "name": "viewport", "content": "width=500, initial-scale=1" }, { "charset": "utf-16" }, { "name": "description", "content": "Benson Arafat Full stack developer" }], "link": [], "style": [], "script": [], "noscript": [], "charset": "utf-16", "viewport": "width=500, initial-scale=1", "title": "Benson Arafat" };
...
const _routes = [
  {
    name: (_a = __nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) != null ? _a : "archive",
    path: (_b = __nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) != null ? _b : "/archive",
    file: "C:/Users/Arafat Benson/Vue/portfolio/pages/archive.vue",
    children: [],
  ...
  },
  {
    ...
    file: "C:/Users/Arafat Benson/Vue/portfolio/pages/index.vue",
    children: [],
