                    ...
                    <a href="">
                        <div class="gatsby-image-wrapper gatsby-image-wrapper-constrained img">
                            ...
                            <picture>
                                ...
                                https://brittanychiang.com/static/3b4d6e8f44baf7e6d7a0ed4b3e4d8d39/d2194/halcyon.png 700w" alt="Halcyon Theme" style="object-fit: cover; opacity: 1;">
                            </picture>
                        </div>
                    </a>
                </div>
...
.projectlist .project-image .img {
    border-radius: 4px;
    mix-blend-mode: multiply;
    filter: grayscale(100%) contrast(1) brightness(90%);
}
.projectlist .project-image a {
    width: 100%;
    height: 100%;
    background-color: #ff5277;
    border-radius: 4px;
...
.projectlist .project-image a::before {
    content: "";
    position: absolute;
    width: 100%;
    height: 100%;
...
.projectlist:nth-of-type(2n+1) .project-image {
    grid-column: 1 / 8;
}
...
.projectlist:nth-of-type(2n+1) .project-links {
    -webkit-box-pack: end;
    justify-content: flex-end;
    margin-left: 0px;
    margin-right: -10px;
}
.projectlist .project-links {
    display: flex;
    -webkit-box-align: center;
    align-items: center;
    position: relative;
...
.projectlist:nth-of-type(2n+1) .project-tech-list li {
...
.projectlist:nth-of-type(2n+1) .project-tech-list {
    -webkit-box-pack: end;
    justify-content: flex-end;
}
.projectlist .project-description a {
    display: inline-block;
    text-decoration: none;
    text-decoration-skip-ink: auto;
    position: relative;
...
.projectlist:nth-of-type(2n+1) .project-content {
    grid-column: 7 / -1;
    text-align: right;
}
